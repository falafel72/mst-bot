use serenity::{builder::{CreateCommand, CreateCommandOption}, all::{ResolvedOption, ResolvedValue, CommandOptionType}};
...
pub fn register() -> CreateCommand {
   CreateCommand::new("cancel")
        ...
        .add_option(
            CreateCommandOption::new(CommandOptionType::User, "user", "The user to cancel the meetup with")
                .required(true),
        )
}
